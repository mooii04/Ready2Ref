...
public record GetArbitroUserEDto(
    ...
    public static GetArbitroUserEDto of(Arbitro arbitro) {
        return new GetArbitroUserEDto(arbitro.getNombre(), arbitro.getPrimerApellido(), arbitro.getSegundoApellido(), arbitro.getEmail(), arbitro.getTelefono(), arbitro.getEdad(), arbitro.getCategoria().toString(), arbitro.getTallaBotas(), arbitro.getTallaCamiseta().toString(), arbitro.getTallaCalzonas().toString(), arbitro.getTallaChandal().toString(), arbitro.getFoto());
    }
